...
" Background and border for floating windows (hover, diagnostics, etc)
hi! link NormalFloat Normal
hi NormalFloat guibg=#151515 guifg=#f6f3e8
hi FloatBorder guifg=#7C7C7C guibg=black

" Floating window title or prompt.
hi FloatTitle guifg=#FFD2A7 guibg=black gui=bold

" For markdown code blocks or inline code inside hover
hi FloatCode guifg=#00A0A0 gui=NONE

" Link float types to regular types.
